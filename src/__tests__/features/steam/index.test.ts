...
vi.mock('../../../features/steam/services/scheduler/index.js', () => ({
  startScheduler,
  stopScheduler,
}));

vi.mock('../../../features/steam/services/notifications/index.js', () => ({
  startNotificationSystem,
  stopNotificationSystem,
}));

vi.mock('../../../features/steam/services/steam/index.js', () => ({
  steamClient: {},
}));
...
describe('steam feature lifecycle', () => {
  ...
  it('starts and stops only once across duplicate calls', async () => {
    const { start, stop } = await import('../../../features/steam/index.js');

...
│   ├── 003_settings.ts
│   ├── 004_notification.ts
│   └── 005_drop_steam.ts    # Compatibility marker; intentionally non-destructive
...
5. `005_drop_steam.ts` — Compatibility marker for Steam removal; intentionally keeps legacy tables intact
